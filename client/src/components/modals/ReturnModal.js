...
const ReturnModal = ({title, author, id, refetch}) => {
    ...
    return (
        <>
            <button
                onClick={openModal}
                className="text-gray-500 hover:bg-gray-200 px-4 rounded-lg py-2">Return
            </button>
            <div
                    ...
                    <div className="mt-3 text-center">
                        ...
                        <div className="mt-2 px-7 py-3">
                            <p className="text-sm text-gray-500">
                                Are you sure you wish to return <span className="font-bold">{title}</span> by <span className="font-bold">{author}</span>?
                            </p>
                        </div>
                        <div className="items-center px-4 py-3">
                            <button
                                id="ok-btn"
                                onClick={deleteLoan}
                                className="flex justify-center px-4 py-2 bg-green-500 text-white text-base font-medium rounded-md w-full shadow-sm hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-300"
                            >
                                {loading ? <Spinner/> : "Yes"}
                            </button>
                        </div>
